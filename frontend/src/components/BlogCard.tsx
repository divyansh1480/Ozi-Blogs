...
export default function BlogCard({ blog }: BlogCardProps) {
  ...
  return (
    <Link href={`/blogs/${blog.slug}`} className="block group">
      <article className="bg-white rounded-xl shadow-sm border border-gray-100 group-hover:shadow-md transition-shadow overflow-hidden h-full">
        {coverImage && (
        ...
        <div className="p-6">
          ...
          <p className="text-gray-500 text-sm line-clamp-3 mb-4">{plainExcerpt}</p>
