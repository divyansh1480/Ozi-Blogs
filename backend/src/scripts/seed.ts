...
const img = (id: string) =>
  `<img src="https://images.unsplash.com/photo-${id}?w=800&auto=format&fit=crop&q=80" alt="" style="width:100%;border-radius:10px;margin-bottom:1.5rem;" />`;
...
const SAMPLE_BLOGS: { title: string; excerpt: string; content: string }[] = [
  ...
  },
  {
    ...
    content: img('1596464716127-f2a82984de30') + '<h2>Safe Sleep Basics</h2><p>The ABCs of safe sleep are simple: Alone, on their Back, in a Crib. But setting up the physical space can feel overwhelming with so many products marketed to new parents.</p><h3>What You Actually Need</h3><p>A firm, flat mattress with a fitted sheet. That is genuinely all you need. No bumpers, no pillows, no positioning wedges.</p>',
  },
  {
  ...
  },
  {
    ...
    content: img('1559526324-593bc073d938') + '<h2>Your Recovery Matters</h2><p>In the haze of new parenthood, self-care often falls completely to the bottom of the list. But a depleted parent cannot pour from an empty cup.</p><p>Postpartum recovery is not just physical. It is emotional, hormonal, and deeply personal.</p>',
  },
  {
    ...
    content: img('1544126592-807ade215a0b') + '<h2>Every Cry Means Something</h2><p>In the early weeks, all cries sound the same. By week 6 or 8, most parents begin to notice subtle differences — a shorter, rhythmic cry for hunger, a higher-pitched wail for pain.</p>',
  },
  {
    ...
    content: img('1476703098952-dec4f4b0e65c') + '<h2>Why We Love Babywearing</h2><p>Babywearing keeps your baby close, supports their development, and frees up your hands for the million other things you need to do.</p><h3>The Ring Sling</h3><p>Perfect for the newborn stage. Takes some practice to position correctly, but once you get it right, it is incredibly quick to put on.</p>',
  },
  {
    ...
    content: img('1436491865332-7a61a109cc05') + '<h2>The Packing List</h2><p>We overpacked on our first trip. We brought three swaddles, two changing mats, and a white noise machine the size of a paperback novel.</p><p>Here is what we actually used.</p>',
  },
  {
    ...
    content: img('1541618258-ec3caebe3fd4') + '<h2>Why Sleep Gets Harder at 4 Months</h2><p>Around 4 months, your baby\'s sleep cycles mature to be more like an adult\'s — meaning they cycle between light and deep sleep more frequently. If they haven\'t learned to link cycles independently, they wake up.</p>',
  },
  {
    ...
    content: img('1493894473891-10fc1e5dbd22') + '<h2>The Science Behind Baby Massage</h2><p>Baby massage has been shown to reduce cortisol levels, improve weight gain in premature infants, and support neurological development.</p><h3>Getting Started</h3><p>Use a small amount of baby-safe oil — coconut or sunflower work well. Start with the legs and feet, where babies are least sensitive.</p>',
  },
  {
    ...
    content: img('1519689373-e33cbfa3bda8') + '<h2>Rhythm Over Schedule</h2><p>A routine is not about watching the clock. It is about doing things in a consistent order — feed, awake time, sleep — so your baby begins to anticipate what comes next.</p>',
  },
  {
    ...
    content: img('1481627834876-b7833e8f5490') + '<h2>Why Books Before They Can Talk</h2><p>Babies absorb language patterns long before they can produce words. Reading aloud exposes them to vocabulary, rhythm, and the pure joy of stories.</p>',
  },
  {
    ...
    content: img('1529903384028-4b7591b66823') + '<h2>Colic Is Temporary (Though It Doesn\'t Feel Like It)</h2><p>Colic typically peaks at 6 weeks and resolves by 3-4 months. That knowledge did not make it easier in the moment, but it helped us hold on.</p>',
  },
  {
    ...
    content: img('1558618666-fcd25c85cd64') + '<h2>We Started with Disposables</h2><p>In the early newborn fog, we reached for disposables. They were easy. They worked. We didn\'t have to think about them.</p><p>At 3 months, we switched to cloth for daytime use. Here is what we found.</p>',
  },
  {
    ...
    content: img('1491013516836-7db643ee5f9e') + '<h2>Preparing Your Older Child</h2><p>Start talking about the new baby months before the birth. Use simple language. Read books about being a big sibling. Let your toddler feel involved in preparations.</p>',
  },
  {
    ...
    content: img('1545558014-8692077e9b5c') + '<h2>When to Start</h2><p>Start baby proofing around 4-5 months — before your baby is mobile. Once they can roll or commando crawl, the window closes faster than you think.</p>',
  },
  {
    ...
    content: img('1544005668-a81e9f8b8e8c') + '<h2>Comfort First</h2><p>Forget the fancy nursing clothes. Layer a nursing tank under anything with a loose neckline and you have instant, discreet access anywhere.</p>',
  },
  {
  ...
  },
  {
    ...
    content: img('1524502397800-2eeaad7c3114') + '<h2>It Gets Better</h2><p>Most children adapt to daycare within two to four weeks. The goodbye is almost always the hardest part — children often settle quickly once the parent has left.</p>',
  },
  {
    ...
    content: img('1518555600-4b62a73ef5a0') + '<h2>The Timing Window</h2><p>Most lactation consultants recommend introducing a bottle between 3 and 6 weeks — after breastfeeding is well established, but before the "bottle refusal" window that can start around 8 weeks.</p>',
  },
  {
    ...
    content: img('1515488042361-ee00e0ddd4e4') + '<h2>6 Months: Starting Simple</h2><p>Begin with single-ingredient purees or soft finger foods. Sweet potato, avocado, and banana are popular starting points. Wait 3-5 days between new foods to watch for reactions.</p><h2>8 Months: Building Variety</h2><p>By now, most babies can handle more texture. Lumpy purees, soft-cooked pasta, and small pieces of ripe fruit work well.</p>',
  },
  {
    ...
    content: img('1555252333-9f8e92e65df9') + '<h2>Why the Evening Is Hard</h2><p>The "witching hour" typically peaks at 6 weeks and resolves by 3-4 months. The cause isn\'t fully understood — it may relate to overstimulation, cluster feeding, or an immature nervous system winding down after a long day.</p>',
  },
  {
    ...
    content: img('1588776814546-1ffbb9b8f0a7') + '<h2>When Teeth Arrive</h2><p>Most babies get their first tooth between 4 and 7 months, though anywhere from 3 to 12 months is within the normal range. The bottom front teeth usually come first.</p>',
  },
  {
  ...
  },
  {
    ...
    content: img('1596464716127-f2a82984de30') + '<h2>Why Routines Work</h2><p>Bedtime routines signal to your baby\'s brain that sleep is coming. Over time, the routine itself becomes a sleep cue — the bath, the feed, the song all begin to trigger drowsiness.</p><h3>Our 20-Minute Routine</h3><p>Bath (optional, 3x per week), massage, fresh diaper and sleep sack, feed in dim light, one song or book, put down drowsy but awake.</p>',
  },
  {
  ...
  },
  {
    ...
    content: img('1559526324-593bc073d938') + '<h2>When They Happen</h2><p>Common growth spurt windows: 1-3 weeks, 6 weeks, 3 months, 6 months, and 9 months. Each lasts 2-7 days. Your baby may want to feed more frequently and sleep more or less than usual.</p>',
  },
  {
    ...
    content: img('1493894473891-10fc1e5dbd22') + '<h2>From 6 Weeks Onwards</h2><p>Most pools and instructors recommend starting after 6 weeks, once your baby has had their first vaccinations. The earlier you start, the more natural the water feels to them.</p>',
  },
  {
    ...
    content: img('1512941937669-90a1b58e7e9c') + '<h2>Do You Need a Monitor at All?</h2><p>In a small home, a basic audio monitor is often enough. Video monitors are genuinely useful if your nursery is far from where you spend most of your time.</p><h3>Movement and Breathing Monitors</h3><p>These can offer reassurance but also cause unnecessary anxiety when false alarms occur. They are not a substitute for a safe sleep environment.</p>',
  },
  {
    ...
    content: img('1544126592-807ade215a0b') + '<h2>When to Start Thinking About It</h2><p>Most dentists recommend phasing out dummy use by age 2, when the habit can start to affect tooth alignment. Emotionally, there is no wrong time — follow your child\'s lead and choose a calm period to make the transition.</p>',
  },
  {
    ...
    content: img('1529903384028-4b7591b66823') + '<h2>Newborns Are Obligate Nasal Breathers</h2><p>Babies under 3 months breathe almost entirely through their nose. A stuffy nose is therefore much more distressing for them than for older children. Saline drops and a gentle nasal aspirator can make a significant difference.</p>',
  },
  {
    ...
    content: img('1518555600-4b62a73ef5a0') + '<h2>Variety From the Beginning</h2><p>Offer a wide range of flavours and textures from 6 months. Babies who are exposed to variety early are more likely to accept new foods as toddlers. Avoid adding salt or sugar to baby food.</p>',
  },
  {
    ...
    content: img('1491013516836-7db643ee5f9e') + '<h2>Why It Works</h2><p>Babies develop motor control before vocal ability. They can physically make simple hand signs months before they can produce words. Signs for "more", "milk", "all done", and "help" have an enormous impact on daily life.</p>',
  },
  {
    ...
    content: img('1545558014-8692077e9b5c') + '<h2>The Moisturiser Is Your Best Friend</h2><p>Twice-daily emollient application — even when the skin looks clear — is the foundation of eczema management. Apply immediately after bath while the skin is still slightly damp to lock in moisture.</p>',
  },
  {
    ...
    content: img('1544005668-a81e9f8b8e8c') + '<h2>Night Feeds Are Normal</h2><p>Newborns need to feed every 2-4 hours around the clock. Their stomachs are small and breast milk or formula digests quickly. Expecting a newborn to sleep through the night is biologically unrealistic.</p>',
  },
  {
    ...
    content: img('1493894473891-10fc1e5dbd22') + '<h2>Birth to 3 Months</h2><p>High-contrast black-and-white images, soft textured fabrics, gentle music, and your own voice and face are the richest sensory experiences for a newborn.</p><h2>4-6 Months</h2><p>Crinkly toys, water play in a shallow dish, mirrors, rattles, and soft chew toys are perfect as babies start reaching and mouthing everything.</p>',
  },
  {
    ...
    content: img('1519689373-e33cbfa3bda8') + '<h2>Our Timeline</h2><p>We began at 9 months when our son was healthy, growing well, and eating three solid meals a day — a good sign he did not need calories overnight. We reduced night feeds one at a time over two weeks, shortening each feed gradually.</p>',
  },
  {
    ...
    content: img('1559526324-593bc073d938') + '<h2>More Than "Baby Blues"</h2><p>The baby blues — tearfulness, mood swings, and anxiety in the first week — are normal and typically resolve within 10 days. Postnatal depression is different: it persists, deepens, and interferes with daily life. It can begin at any time in the first year.</p>',
  },
  {
    ...
    content: img('1476703098952-dec4f4b0e65c') + '<h2>The First 6 Weeks</h2><p>Gentle walking and pelvic floor exercises are the only two things recommended in the first six weeks. Your uterus, ligaments, and pelvic floor are still healing regardless of how you gave birth.</p>',
  },
  {
    ...
    content: img('1524502397800-2eeaad7c3114') + '<h2>Before the Baby Arrives</h2><p>Ideally, choose your paediatrician before the birth. Many practices offer a free meet-and-greet appointment. Use this to assess communication style, availability, and how well they align with your approach to parenting.</p>',
  },
  {
  ...
  },
  {
    ...
    content: img('1588776814546-1ffbb9b8f0a7') + '<h2>What Is the Moro Reflex?</h2><p>The Moro (startle) reflex is an involuntary response to a sudden change in position or loud noise. The baby throws their arms out, arches their back, then pulls their arms in. It typically peaks in the first 4-8 weeks and fades by 4-6 months.</p><h3>Swaddling and the Moro Reflex</h3><p>A snug swaddle contains the arm movement of the Moro reflex, which is why swaddled babies often sleep longer in the early weeks.</p>',
  },
  {
  ...
  },
  {
    ...
    content: img('1544126592-807ade215a0b') + '<h2>What Is Motherese?</h2><p>Infant-directed speech — also called "motherese" or "parentese" — is characterised by slower tempo, higher pitch, exaggerated intonation, and simple vocabulary. Adults produce it instinctively across cultures and languages.</p><h3>Why It Works</h3><p>Studies show that babies pay more attention to infant-directed speech than adult-directed speech. It helps them segment words from continuous speech and learn phonemes more effectively.</p>',
  },
  {
    ...
    content: img('1529903384028-4b7591b66823') + '<h2>Early Hunger Cues</h2><p>Rooting (turning head side to side, mouth open), sucking on fists or tongue, and light fussiness are all early hunger signals. By the time your baby is crying, they are past the easy feeding window.</p><h2>Tired Cues</h2><p>Yawning, eye rubbing, glazed stare, and decreased activity are signs your baby is ready for sleep. Acting on these early cues means an easier settle.</p>',
  },
  {
    ...
    content: img('1519689373-e33cbfa3bda8') + '<h2>Regulating the Body Clock</h2><p>Natural light exposure in the morning is one of the most effective ways to help establish your baby\'s circadian rhythm. Even 20 minutes outside in the morning makes a difference to day-night orientation.</p>',
  },
  {
  ...
  },
  {
    ...
    content: img('1518555600-4b62a73ef5a0') + '<h2>The Convenience Factor Is Real</h2><p>On a long journey, at a restaurant, or during a busy week, pouches are genuinely useful. The problem arises when they replace varied textures and family mealtimes rather than supplementing them.</p><h3>What to Look For on the Label</h3><p>Avoid pouches with added sugar or salt. Look for ones with vegetables as the primary ingredient, not just fruit. Vary brands and flavours to prevent flavour fixation.</p>',
  },
];
...
async function seed() {
  ...
  // Update existing blogs to add images, insert new ones
  let created = 0;
  let updated = 0;
  for (const blog of SAMPLE_BLOGS) {
    ...
    if ((existing as any[]).length > 0) {
      ...
      const blogId = (existing as any[])[0].id;
      const now = new Date().toISOString().slice(0, 19).replace('T', ' ');
      await pool.execute('UPDATE blogs SET content = ?, updatedAt = ? WHERE id = ?', [blog.content, now, blogId]);
      updated++;
      continue;
    }
  ...
  console.log(`✓ Created ${created} new blogs, updated ${updated} existing blogs with images`);
  await closeDatabase();
}
